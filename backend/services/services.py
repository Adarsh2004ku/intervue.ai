...
def classify_resume(raw_text:str)->ParsedResume:
    ...
    prompt = f"""You are a resume parser. Analyze the following resume text
    ...
    except (json.JSONDecoder,Exception) as e:
        logger.error("resume classification failed",error = str(e))
